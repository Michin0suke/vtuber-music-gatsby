...
import { requestVideos, requestVideosLess, upsertRequestVideo, requestVideosCountByTwitterId } from '../queries/requestVideo'
  ...
  return (
        <div className='w-full'>
            <div className='max-w-2xl mx-auto bg-white h-full py-5'>
                ...
                {step !== steps.INIT && step !== steps.FIN &&
                    <div className='mb-10'>
                        <a href={`https://www.youtube.com/watch?v=${requestVideo.id}`} target='_blank' className='block mb-5' rel="noreferrer">
                            <button
                                className='mx-auto block px-4 py-2 bg-red-600 sm:hover:bg-red-500 text-white shadow rounded-full'
                            >動画を確認する</button>
                        </a>
