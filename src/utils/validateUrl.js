...
// スマホ(android)で、VTuberさんのYouTubeURLが無効なURLと表示される時、”https://”に”www."を追加したら有効なURLになったことをここで報告します

const validateVideoUrl = (url) => {
  if (url.match(/youtube.com\/watch\?(\w+=\w+&)?v=([\w-]{11})(&.*)?$/)) {
    return url.match(/youtube.com\/watch\?(\w+=\w+&)?v=([\w-]{11})(&.*)?$/)[2]
  }
